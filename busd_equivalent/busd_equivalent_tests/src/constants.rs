...
// rcontract info
pub const CONTRACT_NAME: &str = "busd_equivalent";
pub const CONTRACT_WASM_NAME: &str = "busd_equivalent.wasm";
pub const PROXY_CONTRACT_NAME: &str = "proxy_contract";
pub const PROXY_CONTRACT_WASM_NAME: &str = "busd_equivalent_test.wasm";
