pub mod key_names {
    ...
    pub const WISE_TOKEN_CONTRACT_HASH: &str = "stakeable_token_contract_hash";
    ...
    pub const GLOBALS_CURRENT_WISE_DAY: &str = "globals_current_stakeable_day";
    ...
    pub const STABLE_USD_EQUIVALENT_YODAS_PER_WISE: &str = "stable_usd_equivalent_yodas_per_stakeable";
    ...
    // key names from stakeable token
    pub const WISE_TOKEN_LIQUIDITY_TRANSFORMER: &str = "stakeable_token_liquidity_transformer";
    pub const WISE_TOKEN_LIQUIDITY_TRANSFORMER_PURSE: &str =
        "stakeable_token_liquidity_transformer_purse";
    pub const WISE_TOKEN_TRANSFORMER_GATE_KEEPER: &str = "stakeable_token_transformer_gate_keeper";
