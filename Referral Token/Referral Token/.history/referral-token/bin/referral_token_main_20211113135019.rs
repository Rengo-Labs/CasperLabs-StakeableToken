...
fn add_referrer_shares_to_end() {
    ...
    ReferralToken::default()._add_referrer_shares_to_end(final_day, shares);
}
#[no_mangle]
fn remove_referrer_shares_to_end() {
    let final_day: U256 = runtime::get_named_arg("final_day");
    let shares: U256 = runtime::get_named_arg("shares");
    ReferralToken::default()._remove_referrer_shares_to_end(final_day, shares);
}
#[no_mangle]
fn add_critical_mass() {
    ...
    ReferralToken::default()._add_critical_mass(referrer, dai_equivalent);
}
...
fn remove_critical_mass() {
    ...
    ReferralToken::default()._remove_critical_mass(referrer, dai_equivalent, start_day);
}
#[no_mangle]
...
fn referrer_interest() {
    let referral_id: u32 = runtime::get_named_arg("referral_id");
    let scrape_days: U256 = runtime::get_named_arg("scrape_days");
    ReferralToken::default().referrer_interest(referral_id, scrape_days);
}
#[no_mangle]
fn referrer_interest_bulk() {
    let referral_ids: Vec<u32> = runtime::get_named_arg("referral_ids");
    let scrape_days: Vec<U256> = runtime::get_named_arg("scrape_days");
    ReferralToken::default().referrer_interest_bulk(referral_ids, scrape_days);
}
#[no_mangle]
fn _referrer_interest() {
    ...
    let referral_id: u32 = runtime::get_named_arg("referral_id");
    let scrape_days: U256 = runtime::get_named_arg("scrape_days");
    ReferralToken::default()._referrer_interest(referrer, referral_id, scrape_days);
}
...
fn check_referrals_by_id() {
    ...
    let (
        ...
        ReferralToken::default().check_referrals_by_id(referrer, referral_id);
    // runtime::ret(
    //     CLValue::from_t((
    //         staker,
    //         stake_id,
...
fn get_entry_points() -> EntryPoints {
    ...
    entry_points.add_entry_point(EntryPoint::new(
        "referrer_interest",
        vec![
            Parameter::new("referral_id", u32::cl_type()),
    ...
    entry_points.add_entry_point(EntryPoint::new(
        ...
        vec![
            Parameter::new("referral_ids", CLType::Option(Box::new(u32::cl_type()))),
            Parameter::new("scrape_days", CLType::Option(Box::new(U256::cl_type()))),
        ],
        <()>::cl_type(),
        EntryPointAccess::Groups(vec![Group::new("constructor")]),
        EntryPointType::Contract,
