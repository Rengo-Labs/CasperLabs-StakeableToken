...
pub fn set_domain_separator(domain_separator: String) {
    set_key(BEP20_DOMAIN_SEPARATOR, domain_separator);
}

pub fn get_domain_separator() -> String {
    get_key(BEP20_DOMAIN_SEPARATOR).unwrap_or_revert()
}

pub fn set_permit_type_hash(permit_type_hash: String) {
    set_key(BEP20_PERMIT_TYPE_HASH, permit_type_hash);
}

pub fn get_permit_type_hash() -> String {
    get_key(BEP20_PERMIT_TYPE_HASH).unwrap_or_revert()
}
