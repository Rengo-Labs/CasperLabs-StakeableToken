...
pub struct BEP20Instance(TestContract);
...
impl BEP20Instance {
    pub fn new(
        ...
        BEP20Instance(TestContract::new(
            env,
            "bep20-token.wasm",
            contract_name,
            sender,
    ...
    pub fn approve(&self, sender: Sender, spender: Key, amount: U256) {
        self.0.call_contract(
            sender,
            "approve",
            runtime_args! {
    ...
    pub fn mint(&self, sender: Sender, account: Key, amount: U256) {
        self.0.call_contract(
            sender,
            "mint",
            runtime_args! {
